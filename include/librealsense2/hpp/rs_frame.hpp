    ...
    */
    ...
    public:
        ...
        */
        ...
        void set_compressed_size(int size) const
        {
            rs2_error* e = nullptr;
            rs2_set_frame_compressed_size(get(), size, &e);
        }

        void set_frame_format(rs2_format format) const
        {
            rs2_error* e = nullptr;
            rs2_set_frame_format(get(), format, &e);
        }
    };
